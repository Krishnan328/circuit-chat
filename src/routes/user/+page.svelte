	...
	const messages = [
		{
			...
			content:
				'Do you know what could beat the exciting feeling of having a new computer? Make yours new PC!',
			timestamp: '14:53',
		...
		},
		{
			...
			content:
				'Have you ever known exactly what you want to cook but searched and scrolled through all of your cookbook books.',
			timestamp: '13:10'
		},
		{
			id: 4,
